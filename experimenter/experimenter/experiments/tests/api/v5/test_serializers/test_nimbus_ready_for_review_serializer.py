...
from experimenter.experiments.api.v5.serializers import NimbusFmlErrorDataClass, NimbusReviewSerializer
...
class TestNimbusReviewSerializerSingleFeature(TestCase):
    ...
    @mock.patch("experimenter.features.manifests.nimbus_fml_loader.NimbusFmlLoader.get_fml_errors")
    def test_serializer_fml_schema_validation_no_channel(self, mock_get_fml_errors):
        fml_diagnostics = [
        ...
        mock_get_fml_errors.return_value = fml_diagnostics
        ...
        ipdb.set_trace()
        self.assertEqual(
            serializer.errors["reference_branch"]["name"],
