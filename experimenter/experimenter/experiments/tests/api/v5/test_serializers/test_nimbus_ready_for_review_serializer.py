...
class TestNimbusReviewSerializerSingleFeature(TestCase):
    ...
    def test_serializer_fml_schema_validation(self, mock_get_fml_errors):
        fml_diagnostics = []
    ...
    def test_serializer_fml_invalid_schema(self, mock_get_fml_errors):
        fml_errors = [
            NimbusFmlErrorDataClass(
                line=0,
                col=0,
        ...
        mock_get_fml_errors.return_value = fml_errors
        ...
        self.assertFalse(serializer.is_valid())
        mock_get_fml_errors.assert_called()
        self.assertIn(
