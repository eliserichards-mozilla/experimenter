...
class TestNimbusFmlLoader(TestCase):
    ...
    def test_get_fml_inspectors(self, get_inspector):
        ...
        result = loader.get_fml_inspectors(clients, "my_feature_id")
    ...
    def test_get_fml_errors(self, get_clients, get_fml_inspectors, get_error):
        loader = self.create_loader()
        ...
        get_fml_inspectors.assert_called()
        get_error.assert_called()
