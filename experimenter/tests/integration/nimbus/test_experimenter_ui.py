...
@pytest.mark.nimbus_ui
def test_subscribe_to_experiment(
    selenium,
    kinto_client,
    create_experiment,
    experiment_url,
    ...
    summary.wait_for_subscribers_visible()
    assert summary.subscribers == "Not set"
    assert summary.subscribe_button == "Subscribe"

@pytest.mark.nimbus_ui
def test_unsubscribe_to_experiment(
    selenium,
    kinto_client,
    create_experiment,
    experiment_url,
    ...
    # click on subscribe
    summary.click_subscribe_button()
    # assert
    assert summary.subscribers == "dev@example.com"
    assert summary.subscribe_button == "Unsubscribe"
