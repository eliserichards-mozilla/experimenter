...
describe("DirectoryColumnUnpublishedUpdates", () => {
  it("renders unpublished updates badge when dirty", () => {
    render(
      <TestTable>
        <DirectoryColumnUnpublishedUpdates {...experiment} publishStatus={NimbusExperimentPublishStatusEnum.DIRTY}/>
      </TestTable>,
    );
    expect(screen.getByTestId("directory-unpublished-updates")).toHaveTextContent(
      "YES"
    );
  });
  ...
  it("renders blank unpublished updates when not dirty", () => {
    render(
      <TestTable>
        <DirectoryColumnUnpublishedUpdates {...experiment} publishStatus={NimbusExperimentPublishStatusEnum.IDLE}/>
      </TestTable>,
    );
    expect(screen.getByTestId("directory-unpublished-updates")).toHaveTextContent(
      ""
